...
1. **Primary sources only** — Every claim traces to a specific volume, page, date, and speaker
2. **Full context** — We do not quote out of context in ways that change meaning
3. **Charitable reading** — We acknowledge reasonable interpretations before presenting our analysis
4. **Complete citations** — Every lyric is mapped to its source
5. **Corrections welcome** — If we have made an error, we want to know
