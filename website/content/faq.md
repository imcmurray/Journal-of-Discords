...
- **[BYU Library](https://contentdm.lib.byu.edu/digital/collection/JournalOfDiscourses3)** — Official LDS academic archive
- **[Archive.org](https://archive.org/search?query=journal+of+discourses)** — Original scans
- **[Wikisource](https://en.wikisource.org/wiki/Journal_of_Discourses)** — Searchable transcriptions

We encourage you to read the full sermons, not just our excerpts. See our [Sources](/sources/) page for more details.
